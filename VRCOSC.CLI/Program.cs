    ...
    public static async Task Main(string[] args)
    {
        try
        {
            ...
            var shouldForceStart = args.Any(a =>
                ...
                string.Equals(a, "--force-start", StringComparison.OrdinalIgnoreCase) ||
            ...
            if (shouldForceStart)
            {
                ConsoleLogger.WriteLog(ConsoleColor.Magenta, "STARTUP", "Force starting VRCOSC Engine modules...");
